...
$$Salary = exp(11.38 + 0.046 I(gender = male) + 0.167 I (rank = associate) + 0.274 I (rank = full) + 0.180 I(dept = genetics) + 0.516 I(dept = medicine) +0.190 I(dept = pediatrics)  - 0.181 I(dept = physiology) + 0.915 I(dept = surgery) - 0.218 I (clin = research) - 0.207 I(cert = not certified) + 0.019 exper - 0.050 I(gender = male, rank = associate) -0.077 I(gender  = male, rank = full )$$ 
...
$$Salary= exp(11.39 + 0.057 I(gender = male)   + 0.181 I(dept = genetics) + 0.498 I(dept = medicine) +0.182 I(dept = pediatrics)  - 0.166 I(dept = physiology) + 0.887 I(dept = surgery)  - 0.225 I (clinresearch) - 0.197 I(cert = not certified) + 0.027 exper))$$
